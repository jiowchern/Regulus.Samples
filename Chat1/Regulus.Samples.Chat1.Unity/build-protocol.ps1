...
dotnet run --project ./../Regulus.Samples.Chat1.Protocol.Outputer Regulus.Samples.Chat1 ./Assets/Project/Plugins/Regulus.Samples.Chat1.Common.dll ./Assets/Project/Plugins/Script
